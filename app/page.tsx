          ...
          <div className="login">
            ...
            <form className="form_container" onSubmit={handleSignIn}>
              ...
              <div className="logo_container">
                <Image src={egg} width={80} height={80} alt={"toast"} />
              </div>
              ...
              <div className="input_container">
                ...
                <input placeholder="name@mail.com" title="Input title" name="input-name" type="text" className="input_field" id="email_field" value={email} onChange={(e) => setEmail(e.target.value)} required />
              </div>
              ...
              <div className="input_container">
                ...
                <input placeholder="Password" title="Input title" name="input-name" type="password" className="input_field" id="password_field" value={password} onChange={(e) => setPassword(e.target.value)} required />
              </div>

              {error && <div className="error_message">{error}</div>} {/* Display error message */}
              {loading ? (
                <button title="Sign In" type="submit" className="sign-in_btn" disabled>
              ...
              <button title="Register" type="button" className="register_btn" onClick={() => router.push("/register")}>
                <span>Register</span>
              </button>
            </form>
          </div>
